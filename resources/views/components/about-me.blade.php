        ...
        <div class="row d-flex">
            <div class="col-md-6 col-lg-5 d-none d-md-flex">
                <div class="img-about img d-flex align-items-stretch">
                    ...
                    <div class="img avatar d-flex align-self-stretch align-items-center ftco-animate"
                         style="background-image:url({{asset('images/pic-removebg-preview.png')}});">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-7 pl-lg-5 pb-5  ">
                <div class="row justify-content-start pb-3">
                    <div class="col-md-12 heading-section ftco-animate">
                        ...
                        <hr>
                        <p><i class="fa fa-graduation-cap text-warning"></i> Educational Attainment</p>
                        <ul class="about-info px-md-0 px-2">

                            <li class="d-flex"><span>School:</span>
                                <span>{{ $personalDetails->educ }}</span>
                            </li>
                            <li class="d-flex"><span>Course:</span>
                                <span>{{ $personalDetails->course }}</span>
                            </li>
                            <li class="d-flex"><span>Year Grad:</span>
                                <span>{{ $personalDetails->yearGrad() }}</span>
                            </li>
